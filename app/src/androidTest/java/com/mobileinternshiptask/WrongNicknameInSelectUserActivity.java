        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.github_nickname_edit_text),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("iop2"), closeSoftKeyboard());
